...
inputs = {
  vm = {
    "TELK" = {
        ...
        domain            = "sof.intra"
        network           = {"PG_Gaia_Teste" = ["192.168.30.231","192.168.30.232","192.168.30.233","192.168.30.234","192.168.30.235","192.168.30.236"]}
        ...
        annotation        = "Servidor de ELK da rede de Testes - 11/05/20226 - Rogerio Vieira Silva"
        tags = {
          "Origem"    = "Terraform"
          "Ambiente"  = "Test"
          "Aplicacao" = "ELK"
