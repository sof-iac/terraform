...
inputs = {
  vm = {
    "TELK" = {
        ...
        domain            = "sof.intra"
        network           = {"PG_Gaia_Teste" = ["192.168.30.231","192.168.30.232","192.168.30.233"]}
        ...
        annotation        = "Servidor do cluster ELK de microsserviços da rede de Testes | João Francisco, COINF | 2026-05-15"
        tags = {
          "Origem"    = "Terraform"
          "Ambiente"  = "Test"
          "Aplicacao" = "ELK"
